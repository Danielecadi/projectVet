...
<template>
	...
	<button @click.prevent="$emit('search', { search, keywords: keywords })"
		class="absolute inset-y-0 right-0 flex justify-center items-center w-[40px] text-gray-100 bg-indigo-700 hover:bg-indigo-800 rounded-md">
